    ...
    <x-slot name="slot">
        <div class="grid grid-cols-12 gap-4">
                                ...
                                <tbody>
                                    @forelse ($institutions as $institution)
                                        <tr>
                                            ...
                                            <td class="actions">
                                                <a href="{{ route('admin.institutions.show', $institution) }}" class="view">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="4" class="px-3 py-4 text-center">
                                                ...
                                                @else
                                                    <span>{{ __('لم يتم إدراج أي مصالح بعد.') }}</span>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforelse
            ...
            <aside class="space-y-4 col-span-full md:col-span-3">
                    <x-buttons.primary-link :href="route('admin.institutions.create')" class="justify-center w-full">
                        <x-heroicon-o-plus class="w-4 h-4" stroke-width="2" />
                        <span>{{ __('إضافة مصلحة جديدة') }}</span>
